...
public class Task1Solver
{
    ...
    public OptimizationResult Solve()
    {
        ...
        var method = new GradientDescentConstantStep();
    ...
    {
        Console.WriteLine("╔════════════════════════════════════════════════════════════════╗");
        Console.WriteLine("║ Метод градиентного спуска с постоянным шагом (Задача 1)        ║");
        Console.WriteLine("╚════════════════════════════════════════════════════════════════╝");
        Console.WriteLine();
        ...
        Console.WriteLine("  t₀ = 0,5 (начальный шаг)");
        Console.WriteLine();
